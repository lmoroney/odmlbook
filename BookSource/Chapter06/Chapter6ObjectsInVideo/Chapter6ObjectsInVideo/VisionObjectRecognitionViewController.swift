/*
See LICENSE folder for the licensing information for the original sample this was derived from.
 
 Original sample at: https://developer.apple.com/documentation/vision/recognizing_objects_in_live_capture
        ...
        objectDetector.process(image) {objects, error in
            ...
            for object in objects!{
                if(object.labels.count>0){
                    ...
                    print(object.labels.enumerated())
